...
% Reducción de tamaño de fuente en todas las tablas
\usepackage{etoolbox} % Para aplicar configuraciones globales
\AtBeginEnvironment{tabular}{\small} % Aplica \small a todas las tablas
\AtBeginEnvironment{longtable}{\small} % Aplica \small también a las tablas largas
