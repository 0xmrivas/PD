...
El centro oferta estudios de ESO, Bachillerato, CFGM de Gestión Administrativa, CFGS de Técnico Superior en Administración y Finanzas, CFGB de Informática de Oficina, CFGBE de Informática de Oficina, CFGM de Sistemas Microinformáticos y Redes, CFGS de Desarrollo de Aplicaciones Web, CFGS de Desarrollo de Aplicaciones Multiplataforma, y los cursos de especialización en Ciberseguridad en entornos de las tecnologías de la información, Desarrollo de Videojuegos y Realidad Virtual, e Inteligencia Artificial y Big Data.ñ
...
A continuación, se especifica el peso de cada uno de los resultados de aprendizaje, así como el de los criterios de evaluación que lo componen. La mayor o menor ponderación de los criterios se obtiene en base al nivel de dificultad y contenidos a desarrollar para cada criterio. La calificación de cada resultado de aprendizaje será la media ponderada de los distintos criterios de evaluación.
...
|  | b) Se han definido protocolos y políticas de autenticación basados en contraseñas y frases de paso, en base a las principales vulnerabilidades y tipos de ataques. |  | B |  |
...
Calificación del RA \=c14 \+ c24 \+ c34 \+ c42 \+ c52 \+ c614+4+4+2+2+1 
...
* Hardening de servidores GNU/Linux. 4ªEdición. Ed. 0xWORD  
...
Tabla 8.3 – Criterios de calificación
